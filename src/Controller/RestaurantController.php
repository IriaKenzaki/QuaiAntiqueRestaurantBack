...
class RestaurantController extends AbstractController
{
    ...
    /** @OA\Post(
     *     path="/api/restaurant",
     *     summary="Création un restaurant",
     *     @OA\RequestBody(*
     *        required=true,
     *        description="Données du restaurant à crée",
     *     @OA\JsonContent(
     *             type="object",
     ...
     *      @OA\Response(
     *          response=200,
     *          description="Restaurant crée avec succés",
     *         @OA\JsonContent(
     *             type="object",
    ...
    public function edit(int $id, Request $request): JsonResponse
    {
        $restaurant = $this->repository->findOneBy(['id' => $id]);
        if ($restaurant) {
            $restaurant = $this->serializer->deserialize($request->getContent(),
                Restaurant::class,
                'json',
